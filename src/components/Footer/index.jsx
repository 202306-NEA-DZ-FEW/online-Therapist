                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-4'>
                    ...
                    <div className='mb-6 md:mb-0 rtl:text-right'>
                        ...
                        <div className='flex items-center flex-shrink-0 w-full mx-auto sm:w-auto rtl:ml-4 ltr:md:mr-4'>
                            <form
                                action='#'
                                className='flex flex-col items-center w-full md:flex-row rtl:text-right'
                            >
                                <input
                                    type='email'
                                    id='email'
                                    placeholder={t("footer.email")}
                                    className='bg-white border border-gray-300 md:w-64 mb-2 md:mb-0 md:mr-2 text-sm rounded-lg block w-full p-2.5 focus:outline-none rtl:m-3'
                                    required
                                />
                                <button
