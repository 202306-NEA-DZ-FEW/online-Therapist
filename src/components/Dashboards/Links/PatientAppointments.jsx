            ...
            <ul className='flex flex-wrap gap-8 m-4'>
                {readyAppointments.map((appointment) => (
                    ...
                    >
                        <img
                            src=
                            {appointment.therapistPhotoURL}
                            alt=
                            {`Photo of ${appointment.therapistFullName}`}
                        ...
                        <p><span className="text-Teal">Therapist :</span>
                          {` ${appointment.therapistFullName}`}
                          </p>

                      
                        <p><span className="text-Teal">Counseling Type :</span>
                          {` ${appointment.counselingType}`}
                          </p>
                        <p><span className="text-Teal">Session Date :</span>
                            {` ${appointment.appointmentDate}`}
                        </p>
                        <p><span className="text-Teal">Time : </span>
