...
function HeroSection() {
 ...
 <Slider {...settings} className='bg-white'>
    {slideImages.map((img) => (
        <><div
        key={img.id}
            style={{ backgroundImage: `url(/Images/${img.imgSrc}.jpg)` }}
       ...
       <div className=' flex flex-col justify-between absolute leading-loose bottom-[25%] text-center left-48 right-48 p-6 bg-opacity-50 bg-white bg-clip-padding'>
                        <div className='space-y-4'>
                            ...
                            <p className="text-lg md:text-xl lg:text-3xl sm:text-md font-medium text-black leading-loose font-atkinson">Access the
                            ...
                            <p className='hidden sm:block text-lg md:text-xl lg:text-3xl font-medium  font-atkinson leading-loose'>
                               ...
                               but with the convenience and  <br/> flexibility of
                                online.
                            </p>
                        </div>
