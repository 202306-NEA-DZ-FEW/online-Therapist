...
const AddComment = ({postId}) => {
  ...
  if (isSubmitting) {
    return <div className="flex justify-center h-44 w-full">
      <Image
        src={Spinner}
        width={100}
        height={100}
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="w-full">
      ...
      <div className="flex md:flex-row flex-col justify-end gap-4 mx-0">
        <Input
          ...
          onChange={onChange}
        />
        <input type="submit" value="add comment" className="shadow bg-teal-700 hover:bg-teal-600 hover:cursor-pointer focus:shadow-outline focus:outline-none text-white font-bold py-1 px-4 rounded h-12" />
