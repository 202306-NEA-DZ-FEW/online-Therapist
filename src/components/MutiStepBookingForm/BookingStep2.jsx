        ...
        <div>
            ...
            <ul className='flex flex-col gap-3 rtl:lg:w-72'>
                <li>
                    <RadioInput
                        name='maritalStatus'
                        value={t("step2.valueText1")}
                        text={t("step2.valueText1")}
                        width='72'
                ...
                <li>
                    <RadioInput
                        name='maritalStatus'
                        value={t("step2.valueText2")}
                        text={t("step2.valueText2")}
                        width='72'
                        onChange={(e) => handleChangeInput(e)}
                    />
                </li>
                <li>
                    <RadioInput
                        name='maritalStatus'
                        value={t("step2.valueText3")}
                        text={t("step2.valueText3")}
                        width='72'
                        onChange={(e) => handleChangeInput(e)}
                    />
                </li>
                <li>
                    <RadioInput
                        name='maritalStatus'
                        value={t("step2.valueText4")}
                        text={t("step2.valueText4")}
                        width='72'
                        onChange={(e) => handleChangeInput(e)}
                    />
                </li>
