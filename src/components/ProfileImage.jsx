...
const ProfileImage = () => {
  ...
  return (
    <>
      <div className='relative inline-flex justify-center w-[14rem] h-[14rem] lg:w-[20rem] lg:h-[20rem] xl:w-[18rem] xl:h-[18rem] rounded-full border-2 border-black/80'>
        <Image
          src={uploading ? Spinner :
