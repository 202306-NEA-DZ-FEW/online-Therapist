    ...
    const onSubmit = async (data) => {
        try {
            ...
            if (userCredential) {
                ...
                toast.success(`Hi ${data.username}👋, ${t("login:account_created")}`)
            }
            await setDoc(
                doc(
                    db,
            ...
            signInWithEmailAndPassword(auth, data.email,
...
export async function getStaticProps ({locale}) {
    return {
        props: {
            ...(await serverSideTranslations(locale, ["therapists", "common", "login"])),
