        ...
        <main className='mx-8 mt-5 lg:mx-20 lg:mt-10 font-atkinson'>
            <div className='mb-10'>
                ...
                <p className='text-xl lg:text-2xl text-center lg:text-left text-gray-500'>
                    ...
                    If you need assistance, please fill out the form below, and
                    ...
                    <form className='flex flex-col gap-3'>
                        ...
                        <label className='lg:text-lg'>
                            <input
                                ...
                                checked={selectedOption === "counselorSupport"}
                                onChange={handleRadioChange}
                                className='mr-2 accent-DarkTeal'
                            />
                        ...
                        <label className='lg:text-lg'>
                            <input
                                ...
                                checked={selectedOption === "businessInquiry"}
                                onChange={handleRadioChange}
                                className='mr-2 accent-DarkTeal'
                            />
                        ...
                        <label className='lg:text-lg'>
                            <input
                                ...
                                checked={
                                    selectedOption === "organizationInterest"
                                }
                                onChange={handleRadioChange}
                                className='mr-2 accent-DarkTeal'
                            />
                        ...
                        <label className='lg:text-lg'>
                            <input
                                ...
                                checked={selectedOption === "billingQuestion"}
                                onChange={handleRadioChange}
                                className='mr-2 accent-DarkTeal'
                            />
                ...
                <div className='hidden lg:block'>
                    ...
                    <div className='bg-LightTeal p-5 mx-auto mt-10 lg:w-3/4 rounded-2xl'>
                        <p>
                            ...
                            Space as a counselor? Submit your information and an
                            Inner Space representative will follow up with you
                            as soon as possible.
                        </p>
                    </div>
                </div>
