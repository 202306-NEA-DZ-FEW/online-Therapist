...
function AddNewCard() {
  ...
  const validationSchema = yup.object().shape({
    ...
    expiryDate: yup
      .string()
      .required("The cards expiry date is required.")
      .length(5, "Please enter the full expiry date."),
    CVC: yup
      .string("Please enter a valid CVC number.")
      .required("CVC is required.")
      .min(3, "Please enter a valid CVC number.")
      .max(4, "Please enter a valid CVC number."),
    nameOnCard: yup
      .string()
    ...
    <Layout>
      <main>
        ...
        <div className='grid grid-cols-1 xl:grid-cols-3 mx-8 my-5 lg:mx-20 lg:my-10'>
          <form onSubmit={handleSubmit(submitHandler)} className='grid col-span-2 grid-cols-1 md:grid-cols-2 gap-y-10'>
            ...
            <button type="submit" className="flex justify-center mt-16 md:mt-0 md:justify-start md:pl-24 my-5 h-20">
